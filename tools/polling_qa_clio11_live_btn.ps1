# clio 11: detail screen -> Live tracking button on location card.
...
Tap 540 400
Start-Sleep -Seconds 4
Write-Host "Live tracking on location card..."
Tap 400 820
...
& $adb logcat -d | Select-String "flutter" | Select-String "Polling|VehicleTracking|Track tapped|Live tracking|Dispose|LivePosition|MarkerUpdate|RoutePolyline|LiveRoute|socket_not|MapAudit" | ForEach-Object { $_.Line } | Set-Content $path -Encoding UTF8
